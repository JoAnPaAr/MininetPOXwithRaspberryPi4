...
def myNetwork():
    ...
    s15 = net.addSwitch('s15', mac="00:00:00:00:01:25")
    ...
    s14.cmd("ip link add s14-tfg2 type gretap local 192.168.117.234 remote 192.168.117.31 ttl 64")
    ...
    s14.cmd("ip link del dev s14-tfg2")
    net.stop()
